...
class SensorModule:
    ...
    def get_distance(self):
        ...
        logging.info(f"Raw distance: {distance / 10.0:.2f} cm")
...
class MotionController:
    ...
    def back_up(self, duration=1, velocity=-50):
...
class MainAutonomousController:
    ...
    def __init__(self):
        ...
        self.running = True
        Avoidance.init()
        Avoidance.HWSONAR = self.sensor_module.sonar  # Use the same sonar instance
    ...
    def start(self):
        ...
        try:
            ...
            while self.running:
                self.handle_object()
                time.sleep(0.1)  # Adjusted for responsiveness
