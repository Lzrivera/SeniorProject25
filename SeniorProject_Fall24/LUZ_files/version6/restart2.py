...
class SensorModule:
    ...
    def get_distance(self):
        ...
        smoothed_distance = np.mean(self.history)
...
class MainAutonomousController:
    ...
    def __init__(self):
        ...
        self.running = True
        Avoidance.init()
        Avoidance.HWSONAR = self.sensor_module.sonar  # Initialize HWSONAR
    ...
    def handle_object(self):
        ...
        elif distance > 30.0 and distance <= 30.48:  # Far object within one foot
